...
The concept of the DPP was first introduced through the EU Battery Regulation, which came into force in 2023. This regulation mandated DPPs for batteries used in electric vehicles, industrial applications, and portable electronics. This Battery Passport was formerly part of this standard as well and is with a common model of IDTA and Catena-X now addressed in CX-XXXX Battery Passport. Building on the foundational framework of the Battery Regulation, the European Union expanded the scope of DPPs through the Ecodesign for Sustainable Products Regulation (ESPR), which entered into force in July 2024 (see chapter [References](./references#normative-references) ).

Battery Passports are out of scope and are addressed within the Standard CX-XXXX Battery Passport.
...
As Catena-X is an data ecosystem which focuses on trust through identification, the architecture and scope focuses on the interaction of restricted / access controlled information and not on public interfaces.
...
In order to proof conformity with this use case digital product pass standard
Data Provider / Consumer and Business Application Provider MUST demonstrate that they
...
- can identify the correct version of the semantic model (see [Backward Compatibility](./CX-0143-BackwardCompatibility.md#backward-compatibility-requirements))

### 1.4 EXAMPLES

> *This section is non-normative*

The following example can be checked as it offers further explanations and guidance how to stay compliant with the standard:
...
- **Asset Administration Shell (AAS):** The AAS is the chosen standard in Catena-X to define digital twins
  of an asset (e.g. a transmission or a full vehicle). The AAS, developed by the [Industrial Digital Twin Association](https://industrialdigitaltwin.org/,) is the standardized digital representation of an digital twin asset, the corner stone for the interoperability of Industry 4.0 components organized in Industry 4.0 systems.
