...
/**
 * Build graph data structure from standard files in docs/standards only (no versioning).
 * @param {string} repoRoot - Root of the repository.
 */
function buildGraphData(repoRoot) {
  const standardsDir = path.join(repoRoot, 'docs', 'standards');
...
module.exports = {
  ...
  extractNormativeReferenceSections,
  parseStandardFile,
  parseStandardsFromDir,
  buildEdges,
};
