...
- PDF-Version: [Template for a Data Licensing Agreement English Version](./assets/DATA LICENSING AGREEMENT .docx)
- PDF-Version: [Template for a Data Licensing Agreement German Version](./assets/VERTRAG ZUR ZEITWEISEN ÜBERLASSUNG VON DATEN.docx)
