...
Catena-X standardized semantic models are a crucial enabler to assure interoperability between independent solutions. Only when data consumers, data providers and business applications speak the "same language", data can be exchanged and embedded seamlessly between use cases and applications which are developed by different organizations. A standardized semantic model is needed when:
...
Furthermore, standardized semantic models lower the cost for making data accessible and, therefore, speed up the return on investment or even make business cases possible in the first place.

Although semantic models are built to be used as blueprints for Digital Twins ([see CX–0002](https://catenax-ev.github.io/docs/standards/CX-0002-DigitalTwinsInCatenaX)), they can be used by other data exchange mechanisms as well.
...
![State transitions of aspect models during their lifecycle](./assets/status-allowed-transitions.svg)
...
- [ ] use Camel-Case (e.g. "MyModelElement" or "TimeDifferenceGmtId" when in doubt follow [style guide](https://google.github.io/styleguide/javaguide.html#s5.3-camel-case))
...
[6]  [Registration of AAS Submodel Templates for Digital Twins (IDTA Submodels). Process Description. V1.0. Digital Twin Association. Dec. 2022.](https://industrialdigitaltwin.org/wp-content/uploads/2022/12/2022-12_01_IDTA_Process-Description-Registration-of-AAS-Submodel-Templates-for-Digital-Twins.pdf)

[8] [The Catena-X Standard Library](https://catenax-ev.github.io/docs/standards/overview).
...
[5] How to Create a Submodel Template Specification. Guideline. Industrial Digital Twin Association. Dec. 2022. Download from: [Guideline-How to create a submodel template specification](https://industrialdigitaltwin.org/wp-content/uploads/2022/12/I40-IDTA-WS-Process-How-to-write-a-SMT-FINAL-.pdf)

[6] IP Regulations of the Association Catena-X Automotive Network e.V (see [IP Regulations](https://catena-x.net/wp-content/uploads/2026/02/260128_Catena-X_IP-Regulations.pdf))
...
[SOURCE: Embley, D.W. (2009). Semantic Data Model. In: LIU, L., ÖZSU, M.T. (eds) Encyclopedia of Database Systems. Springer, Boston, MA. [https://doi.org/10.1007/978-0-387-39940-9_105](https://doi.org/10.1007/978-0-387-39940-9_105)]
