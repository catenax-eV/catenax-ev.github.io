...
# CX-0050 Catena-X-specific verifiable credentials v.2.2.1
...
- Core Service Provider-B (CSP-B), as this is the entity issuing the Verifiable Credentials
...
- [CX-0010](https://catenax-ev.github.io/docs/standards/CX-0050-BusinessPartnerNumber)
