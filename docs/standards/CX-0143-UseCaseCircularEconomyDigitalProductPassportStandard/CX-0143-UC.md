...
[CX-0006](./CX-0143-UC/#111-list-of-standalone-standards),
[CX-0013](./CX-0143-UC/#111-list-of-standalone-standards),
[CX-0014](./CX-0143-UC/#111-list-of-standalone-standards) and
[CX-0015](./CX-0143-UC/#111-list-of-standalone-standards)
...
In case the **OPTIONAL** `drill down functionality` is integrated in the application using the IRS [CX-0005](./CX-0143-UC/#111-list-of-standalone-standards), the digital twin **MUST** have a `globalAssetId` attribute with the Global Unique UUID of the asset.
...
| Batteries        | BatteryPass v6.1.0                 | `batteryPass`        |
| Transmissions    | Transmission Pass 3.1.0            | `transmissionPass`   |

- The data provider also **MUST** provide a API Endpoint following the [CX-0002](./CX-0143-UC/#111-list-of-standalone-standards).
