...
The **Catena-X Automotive Network e. V.** (hereinafter referred to as the "Catena-X Association" or "the Association") is responsible for standardization, certifications, and governance of the Catena-X ecosystem. Members of the Association may participate in committees, working groups, and/or expert groups to actively shape the Catena-X ecosystem. The Catena-X Association publishes standards with the objective of enabling interoperability, data sovereignty, and security for all participants in the data space. The ecosystem participants must comply with the standards published by the Catena-X Association in order to operate within the data space. The Catena-X standards are based on internationally recognized concepts and principles, relevant industry standards, and established best practices, and are extended to address automotive-specific and use case–specific requirements. Through the certification of ecosystem participants and software components, the Catena-X Association ensures transparency and trust within the ecosystem. A certification testifies, for example, that a software component is interoperable, data sovereign, and safe to use in the Catena-X data space.
The Association is complemented by the **development environment**, which focuses on the creation of standardization candidates for submission to the Association’s standardization process, as well as on the development of open-source reference implementations and other implementations for the data space.
In the **operating environment**, the various open-source and commercial services and business applications are operated by various providers. A detailed description of the provider roles and the associated software components is provided in Chapter  [Who: Roles in the Catena-X Ecosystem](./../who-roles-in-the-catena-x-ecosystem/who-roles-in-the-catena-x-ecosystem.md) and Chapter [What: Service Map](./../what-service-map/what-service-map.md).
Together, these three components form the Catena-X data ecosystem. The following chapters describe the roles, responsibilities, and functions of these components in detail.
...
Catena-X offers use case KITs, published via Eclipse Tractus-X, to enable a multi-vendor ecosystem of software solutions and services for each Catena-X use case. Solution and service providers develop data-sovereign and interoperable offerings based on the defined standards and offer them through trusted marketplaces within the Catena-X data space ([Who: Roles in the Catena-X Ecosystem](./../who-roles-in-the-catena-x-ecosystem/who-roles-in-the-catena-x-ecosystem.md)). These marketplaces are certified and provide interoperable solutions from multiple solution providers. The Core Services as well as marketplaces are parts of the Catena-X ecosystem and are operated by certified operating companies (see Figure [Service Map](./../what-service-map/what-service-map.md)). This comprehensive solution portfolio enables participants across the automotive value chain to generate business value through data-driven use cases and end-to-end data chains.
...
1. The International Data Space Association (IDSA) provides architecture principles that enable sovereign data exchange.

2. The Eclipse Foundation hosts the official open-source development project of the Catena-X ecosystem and follows the Eclipse Foundation’s trusted development process.

3. The Catena-X Association provides industry-specific governance for the ecosystem that equally reflects the diverse interest groups within the automotive industry to serve common business needs. It also defines the vision, mission, and guiding principles for the Catena-X data space through the governance framework based on the Catena-X Statutes.
...
4. **Organizational Interoperability:**
    ...
    Organizational interoperability focuses on the alignment of key structures, processes, and roles across diverse stakeholders. The minimum effort to achieve organizational interoperability with Catena-X means to acknowledge the Catena-X Governance and its essential roles. By utilizing certified Catena-X [Core Service Provider](../who-roles-in-the-catena-x-ecosystem/who-roles-in-the-catena-x-ecosystem.md#core-service-provider-a) and [OSPs](../who-roles-in-the-catena-x-ecosystem/who-roles-in-the-catena-x-ecosystem.md#onboarding-service-provider), participants can access and operate within the data space in a consistent and efficient manner. In this context, the Catena-X Automotive Network e. V. plays a central role in fostering collaboration across the ecosystem and with relevant standardization and open-source initiatives.
