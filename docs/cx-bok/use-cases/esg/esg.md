...
| --- | --- | --- | :---: |
| [Practical Guide for Mapping of Human Rights Regulations](./assets/documents/20260902-practical-guide-human-rights-mapping.pdf) | The Practical Guide provides a structured approach to identifying, assessing, and prioritizing human rights risks across value chains. It supports organizations in meeting due diligence requirements and strengthening responsible business practices through clear guidance and practical examples. | ![Media File](./assets/icons/pdf-icon.png) | EN |
